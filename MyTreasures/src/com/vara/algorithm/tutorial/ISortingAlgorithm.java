...
public interface ISortingAlgorithm {
	...
	/**
	 * Applies quick sorting algorithm over the underlying array of elements. 
	 * This technique uses 39% more comparisons than merge sort but faster than merge sort. 
	 */
	void applyQuickSort();
	void display();
}
